'''
Author: Macielyoung
Date: 2023-11-09 11:24:46
Description: merge tokenizer with adding chinese tokens
'''
import os
...
# load tokenizer
llama_tokenizer = LlamaTokenizer.from_pretrained(llama_tokenizer_dir, use_fast=False)
...
# save huggingface tokenizer models
