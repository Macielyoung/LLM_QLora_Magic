'''
Author: Macielyoung
Date: 2023-10-26 15:17:09
Description: deploy streaming and non-streaming server with finetuned model
'''
import argparse
import json
...
@app.post("/ai/llm/generation_stream")
async def generate(request: Request) -> Response:
    ...
    # add system prompt
    prompt = build_chat_input(message, history)
