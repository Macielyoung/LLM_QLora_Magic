...
def train(
    ...
    output_dir: str = "../models/codellama/v2",
    ...
    logger.info(
        f"Training CodeLlama-QLoRA model with params:\n"
    ...
    # CodeLlama model tokenizer have bos, eos and pad token
...
def parse_args():
    ...
    parser.add_argument("--pretrained", type=str, default="", help="pretrained model from huggingface hub")
