...
def train(
    ...
    output_dir: str = "../models/zephyr-7b-chinese/v1/",
    ...
    logger.info(
        f"Training zephyr-7b-chinese-QLoRA model with params:\n"
    ...
    # zephyr tokenizer without pad and eos token
...
if __name__ == "__main__":
    ...
    #       )
    base_model = "/root/pretrained/zephyr-7b-chinese"
